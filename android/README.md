...
## Иконка приложения 1.2.1

Android-приложение использует тот же знак камеры, что и десктопный Stream Control Center.
Добавлены обычные, круглые и адаптивные launcher icons для Android 8+.
Исходник десктопной иконки сохранён в `res/drawable-nodpi/stream_control_desktop_icon.png`.
